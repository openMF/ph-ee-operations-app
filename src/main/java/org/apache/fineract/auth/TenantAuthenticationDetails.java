...
public class TenantAuthenticationDetails implements Serializable {
    ...
    public TenantAuthenticationDetails(HttpServletRequest request) {
        this(request.getRemoteAddr(), extractSessionId(request), extractTenant(request));
    }

    public TenantAuthenticationDetails(String remoteAddress, String sessionId, String tenant) {
