...
public interface BatchRepository extends JpaRepository<Batch, Long>, JpaSpecificationExecutor<Batch> {
    ...
    @Query("SELECT bt FROM Batch bt " + "WHERE bt.registeringInstitutionId LIKE :registeringInstituteId AND bt.payerFsp LIKE :payerFsp AND "
    ...
    @Query(value = "SELECT bt FROM Batch bt WHERE bt.startedAt BETWEEN :dateFrom AND :dateTo AND "
            + "(bt.registeringInstitutionId LIKE :registeringInstitutionId) AND (bt.payerFsp LIKE :payerFsp) AND "
            + "bt.batchId LIKE :batchId AND bt.subBatchId IS NULL")
    List<Batch> findAllFilterDateBetween(Date dateFrom, Date dateTo, String registeringInstitutionId, String payerFsp, String batchId,
            Pageable pageable);
    ...
    @Query(value = "SELECT COUNT(bt) FROM Batch bt " + "WHERE bt.startedAt >= :dateFrom AND "
            + "(bt.registeringInstitutionId LIKE :registeringInstitutionId) AND (bt.payerFsp LIKE :payerFsp) AND "
            + "bt.batchId LIKE :batchId AND bt.subBatchId IS NULL")
    Optional<Long> getTotalBatchesDateFrom(Date dateFrom, String registeringInstitutionId, String payerFsp, String batchId);

    @Query(value = "SELECT COUNT(bt) FROM Batch bt " + "WHERE bt.startedAt <= :dateTo AND "
            + "(bt.registeringInstitutionId LIKE :registeringInstitutionId) AND (bt.payerFsp LIKE :payerFsp) AND "
            + "bt.batchId LIKE :batchId AND bt.subBatchId IS NULL")
    Optional<Long> getTotalBatchesDateTo(Date dateTo, String registeringInstitutionId, String payerFsp, String batchId);

    @Query(value = "SELECT COUNT(bt) FROM Batch bt " + "WHERE bt.startedAt BETWEEN :dateFrom AND :dateTo AND "
            + "(bt.registeringInstitutionId LIKE :registeringInstitutionId) AND (bt.payerFsp LIKE :payerFsp) AND "
            + "bt.batchId LIKE :batchId AND bt.subBatchId IS NULL")
    ...
    @Query(value = "SELECT SUM(bt.totalTransactions) FROM Batch bt " + "WHERE bt.startedAt >= :dateFrom AND "
            + "(bt.registeringInstitutionId LIKE :registeringInstitutionId) AND (bt.payerFsp LIKE :payerFsp) AND "
            + "bt.batchId LIKE :batchId AND bt.subBatchId IS NULL")
    Optional<Long> getTotalTransactionsDateFrom(Date dateFrom, String registeringInstitutionId, String payerFsp, String batchId);

    @Query(value = "SELECT SUM(bt.totalTransactions) FROM Batch bt " + "WHERE bt.startedAt <= :dateTo AND "
            + "(bt.registeringInstitutionId LIKE :registeringInstitutionId) AND (bt.payerFsp LIKE :payerFsp) AND "
            + "bt.batchId LIKE :batchId AND bt.subBatchId IS NULL")
    Optional<Long> getTotalTransactionsDateTo(Date dateTo, String registeringInstitutionId, String payerFsp, String batchId);

    @Query(value = "SELECT SUM(bt.totalTransactions) FROM Batch bt " + "WHERE bt.startedAt BETWEEN :dateFrom AND :dateTo AND "
            + "(bt.registeringInstitutionId LIKE :registeringInstitutionId) AND (bt.payerFsp LIKE :payerFsp) AND "
            + "bt.batchId LIKE :batchId AND bt.subBatchId IS NULL")
    Optional<Long> getTotalTransactionsDateBetween(Date dateFrom, Date dateTo, String registeringInstitutionId, String payerFsp,
            String batchId);
    ...
    @Query(value = "SELECT SUM(bt.totalAmount) FROM Batch bt " + "WHERE bt.startedAt >= :dateFrom AND "
            + "(bt.registeringInstitutionId LIKE :registeringInstitutionId) AND (bt.payerFsp LIKE :payerFsp) AND "
            + "bt.batchId LIKE :batchId AND bt.subBatchId IS NULL")
    Optional<Long> getTotalAmountDateFrom(Date dateFrom, String registeringInstitutionId, String payerFsp, String batchId);

    @Query(value = "SELECT SUM(bt.totalAmount) FROM Batch bt " + "WHERE bt.startedAt <= :dateTo AND "
            + "(bt.registeringInstitutionId LIKE :registeringInstitutionId) AND (bt.payerFsp LIKE :payerFsp) AND "
            + "bt.batchId LIKE :batchId AND bt.subBatchId IS NULL")
    Optional<Long> getTotalAmountDateTo(Date dateTo, String registeringInstitutionId, String payerFsp, String batchId);

    @Query(value = "SELECT SUM(bt.totalAmount) FROM Batch bt " + "WHERE bt.startedAt BETWEEN :dateFrom AND :dateTo AND "
            + "(bt.registeringInstitutionId LIKE :registeringInstitutionId) AND (bt.payerFsp LIKE :payerFsp) AND "
            + "bt.batchId LIKE :batchId AND bt.subBatchId IS NULL")
    ...
    @Query(value = "SELECT SUM(bt.approvedAmount) FROM Batch bt " + "WHERE bt.startedAt >= :dateFrom AND "
            + "(bt.registeringInstitutionId LIKE :registeringInstitutionId) AND (bt.payerFsp LIKE :payerFsp) AND "
            + "bt.batchId LIKE :batchId AND bt.subBatchId IS NULL")
    ...
    @Query(value = "SELECT SUM(bt.approvedAmount) FROM Batch bt " + "WHERE bt.startedAt <= :dateTo AND "
            + "(bt.registeringInstitutionId LIKE :registeringInstitutionId) AND (bt.payerFsp LIKE :payerFsp) AND "
            + "bt.batchId LIKE :batchId AND bt.subBatchId IS NULL")
    Optional<Long> getTotalApprovedAmountDateTo(Date dateTo, String registeringInstitutionId, String payerFsp, String batchId);

    @Query(value = "SELECT SUM(bt.approvedAmount) FROM Batch bt " + "WHERE bt.startedAt BETWEEN :dateFrom AND :dateTo AND "
            + "(bt.registeringInstitutionId LIKE :registeringInstitutionId) AND (bt.payerFsp LIKE :payerFsp) AND "
            + "bt.batchId LIKE :batchId AND bt.subBatchId IS NULL")
    Optional<Long> getTotalApprovedAmountDateBetween(Date dateFrom, Date dateTo, String registeringInstitutionId, String payerFsp,
            String batchId);
    ...
    @Query(value = "SELECT SUM(bt.approvedCount) FROM Batch bt " + "WHERE bt.startedAt >= :dateFrom AND "
            + "(bt.registeringInstitutionId LIKE :registeringInstitutionId) AND (bt.payerFsp LIKE :payerFsp) AND "
            + "bt.batchId LIKE :batchId AND bt.subBatchId IS NULL")
    Optional<Long> getTotalApprovedCountDateFrom(Date dateFrom, String registeringInstitutionId, String payerFsp, String batchId);

    @Query(value = "SELECT SUM(bt.approvedCount) FROM Batch bt " + "WHERE bt.startedAt <= :dateTo AND "
            + "(bt.registeringInstitutionId LIKE :registeringInstitutionId) AND (bt.payerFsp LIKE :payerFsp) AND "
            + "bt.batchId LIKE :batchId AND bt.subBatchId IS NULL")
    Optional<Long> getTotalApprovedCountDateTo(Date dateTo, String registeringInstitutionId, String payerFsp, String batchId);

    @Query(value = "SELECT SUM(bt.approvedCount) FROM Batch bt " + "WHERE bt.startedAt BETWEEN :dateFrom AND :dateTo AND "
            + "(bt.registeringInstitutionId LIKE :registeringInstitutionId) AND (bt.payerFsp LIKE :payerFsp) AND "
            + "bt.batchId LIKE :batchId AND bt.subBatchId IS NULL")
    Optional<Long> getTotalApprovedCountDateBetween(Date dateFrom, Date dateTo, String registeringInstitutionId, String payerFsp,
            String batchId);
}
