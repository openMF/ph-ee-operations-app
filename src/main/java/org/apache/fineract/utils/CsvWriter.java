...
public final class CsvWriter<T> {
     ...
     * @see [writeCsvHeaders], [writeData] and [closeStream]
     */
     ...
     *
     * @param csvHeader
     *            the headers to be written in csv of type string array
     * @throws WriteToCsvException
     ...
     *
     * @param nameMapping
     *            string array of the fields to be populated from POJO
     * @param objects
     *            list of the objects to be translated into rows in csv
     * @throws WriteToCsvException
     * @see [performErrorProneTask]
     */
     ...
     * @param <T>
     *            generic return type of the successful callback call
     ...
     *
     * @param pojoClass
     *            the Class instance of the generic type [T]
     * @param <T>
     *            the generic type for [pojoClass]
